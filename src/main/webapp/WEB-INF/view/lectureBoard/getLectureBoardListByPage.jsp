...
<title>getLectureBoardListByPage</title>
<!-- CSS 링크 -->
				        	...
				        	<div class="card-body">
			            		<div>
			            			...
			            			<c:if test="${sessionLoginMember.memberLevel >= 5}">
					            		<div>
									        <a href="${pageContext.request.contextPath}/teacher/lectureBoard/addLectureBoard">
									        	<input type="button" class="btn btn-success" style="float: right" value="강의게시글입력">
									        </a>
								        </div>
							        </c:if>
						   		</div>
				          		<div class="mt-2" style="height:auto; width:auto;">
				            		<table id="zero_config" class="table table-striped table-bordered no-wrap">
			                            ...
			                            <tbody>
							                <tr>
												<c:forEach var="lb" items="${lectureBoardList}">
													<tr>
					            	...
					            	<div style="text-align: center;">
						            	<form method="get" action="${pageContext.request.contextPath}/all/letcureBoard/getLectureBoardListByPage">
