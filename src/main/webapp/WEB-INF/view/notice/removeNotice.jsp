	...
	$('document').ready(function(){
		$('#uploadRemoveNotice').click(function(){
			...
			if($('#inputRemoveNoticeNo').val() != $('#removeNoticeNo').val() || $('#inputRemoveNoticeNo').val() == ''){
				$('#inputRemoveNoticeNoHelper').text('입력한 번호를 다시 확인해주세요')
			} else {
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-12 col-md-12">
				    <div class="card">
				        <div class="card-body">
				            <h4 class="card-title">공지사항 삭제(블라인드)</h4>
				            <div class="mt-2" style="height:auto; width:auto;">
								<form id="removeNoticeForm" action="${pageContext.request.contextPath}/manager/notice/removeNotice" method="post">
									<table id="zero_config" class="table table-striped table-bordered no-wrap">
										...
										<tr>
											...
											<td>
												...
												<span id="inputRemoveNoticeNoHelper" class="helper"></span>
											</td>
										</tr>
									</table>
									<div>
