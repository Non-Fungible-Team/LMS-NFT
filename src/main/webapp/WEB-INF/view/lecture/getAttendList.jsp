									...
									<table id="zero_config" class="table table-striped table-bordered no-wrap">
										<thead>
											<tr>
												...
												<th>생성날짜</th>
												<th>
													<a href="${pageContext.request.contextPath}/manager/lecture/addAttend" class="btn btn-primary btn-rounded"> 
												...
												<tr>
													...
													<td>
														<div class="btn-group" role="group" aria-label="Basic example">
															<a href="${pageContext.request.contextPath}/#" class="btn btn-info">수정</a> 
