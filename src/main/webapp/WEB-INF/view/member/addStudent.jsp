...
<body>
	...
	<form id="signUpStudent" method="post"
		...
		<table>
			...
			<tr>
				<td>성별</td>
				<td><input type="radio" value="male" name="studentGender"
					class="gender">남 <input type="radio" value="female"
					name="studentGender" class="gender">여 <span
					id="studentGenderHelper" class="helper"></span></td>
			</tr>
			<tr>
				<td>이메일</td>
				<td><input type="text" id="studentEmailId"
					name="studentEmailId" value="stud2"> @ <select id="emailUrl"
					name="emailUrl">
						<option value="">::선택::</option>
						<option value="naver.com">네이버</option>
						<option value="daum.net">다음</option>
						<option value="gmail.com">지메일</option>
				</select> <span id="studentEmailIdHelper" class="helper"></span></td>
			</tr>
			<tr>
				<td>주소</td>
