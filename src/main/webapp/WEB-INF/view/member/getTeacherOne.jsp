						...
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-body">
									...
									<div>
										<a href="${pageContext.request.contextPath}/all/modifyTeacher?memberId=${loginMember.memberId}" class="btn btn-rounded btn-outline-info">강사 정보 수정</a>
										<span></span>
										<a href="${pageContext.request.contextPath}/all/freezeTeacher?memberId=${loginMember.memberId}" class="btn btn-rounded btn-outline-danger">강사 정보 삭제</a>
									</div>
								</div>
							</div>
						</div>
