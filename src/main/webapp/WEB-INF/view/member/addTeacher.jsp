...
$('document').ready(function(){
	...
	$('#addrBtn').click(function(){
		...
		var keyword = $('#keyword').val();
			console.log('[addteacher.jsp.keyword] keyword : ' + keyword)
				...
				<div class="container p-5 my-5 border">
					<div class="row">
						<div class="col-lg-12 col-md-12">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title">강사 회원 가입</h4>
									<div class="mt-2" style="height: auto; width: auto;">
										<!-- 테이블 넣는곳, 테이블 색깔 변경 ->class만 변경 -->	<form id="signUpTeacher" method="post"	action="${pageContext.request.contextPath}/addTeacher">
											<table id="zero_config" class="table table-striped table-bordered">
												...
												<tr>
													<td>입사일</td>
													<td>
														<input type="date" id="teacherEntryDate" name="teacherEntryDate" > 
												...
												<tr>
													<td>레벨</td>
													<td>
														<input type="number" id="memberLevel" name="memberLevel" value="2" readonly="readonly">
													</td>
												</tr>
